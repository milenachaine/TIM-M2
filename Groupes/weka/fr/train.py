...
'''
	...
	Ce programme génère un fichier.arff (train_fr.arff) contenant les vecteurs des features lus à partir du programme getfeatures.py
	Ensuite, à partir de ce fichier .arff, il crée un modèle qui sera utilisé lors de l'exécution du script predict.py.
	
	Lancement: python3	train.py	fr_corpus_stem-train.xml	nom_modele
