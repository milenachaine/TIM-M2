...
'''
	...
	Ce programme génère un fichier.arff (test_fr.arff) et, en exploitant le modèle généré par le programme train.py, predit la classe des articles contenu dans le corpus test. 
	
	Lancement: python3	train.py	fr_corpus_stem-test.xml	nom_modele prediction_nom_modele.xml
...
data = loader.load_file("test_fr.arff")
data.class_is_last()
