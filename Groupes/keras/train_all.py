...
'''
def ecrit(txt, label):
  with (open("train_all.txt",'a', encoding="utf-8")) as train:
    with(open("train_label_all.txt",'a', encoding="utf-8")) as train_label:
      with (open("test_all.txt",'a', encoding="utf-8")) as test:
        with(open("test_label_all.txt",'a', encoding="utf-8")) as test_label:
          i = 0
          for t in txt:
            if i % 2 == 0:
              train.write(t)
...
if __name__ == "__main__":
  ...
  train("train_all.txt", "train_label_all.txt")
